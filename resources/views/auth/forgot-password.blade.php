...
<head>
    ...
    <title>LandCaffe - Reset Password</title>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group">
                ...
                <input id="email" class="form-control" type="email" name="email" :value="old('email')" placeholder="Enter your email address" required autofocus>
                @error('email')
